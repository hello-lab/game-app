    ...
    <div>
      ...
      <div className="par1">
          ...
          {cards.length === 0 ? (
            ...
            cards.map((hand, handIndex) => (
              <div key={handIndex} className="hand">
                <p className="player">{["PLAYER A", "PLAYER B"][handIndex]}</p>
        ...
        <div>
          ...
          <br></br>
          <br></br>
          <div className="Winning-Hand Straight">
            <div>Straight: 4x</div>

            <div className="probablity">
              <p
                className={` ${winbetS == "A" ? "active" : "inactive"}`}
                onClick={() => handleclik("A", "S")}
              >
                A
              </p>
              <p
                className={` ${winbetS == "B" ? "active" : "inactive"}`}
                onClick={() => handleclik("B", "S")}
              >
                B
              </p>
              <div className="bet-controls">
                <div>
                  <input
                    ...
                    type="number"
                    value={betAmountS}
                    onChange={(e) => setbetAmountS(Number(e.target.value))}
                    placeholder="Enter bet amount"
                    disabled={!isCrashed}
                  />
                  &nbsp;
                  <button
                    ...
                    disabled={!isCrashed || isBetPlacedS}
                  >
                    Place Bet
                  </button>
                  &nbsp;
          ...
          <br></br>
          <br></br>
          <div className="Winning-Hand Flush">
            <div>Flush: 3x</div>

            <div className="probablity">
              <p
                className={` ${winbetF == "A" ? "active" : "inactive"}`}
                onClick={() => handleclik("A", "F")}
              >
                A
              </p>
              <p
                className={` ${winbetF == "B" ? "active" : "inactive"}`}
                onClick={() => handleclik("B", "F")}
              >
                B
              </p>
              <div className="bet-controls">
                <div>
                  <input
                    ...
                    type="number"
                    value={betAmountF}
                    onChange={(e) => setbetAmountF(Number(e.target.value))}
                    placeholder="Enter bet amount"
                    disabled={!isCrashed}
                  />
                  &nbsp;
                  <button
                    onClick={handlePlaceBetF}
                    disabled={!isCrashed || isBetPlacedF}
                  >
                    Place Bet
                  </button>
                  &nbsp;
          ...
          <br></br>
          <br></br>
          <div className="Winning-Hand Straight-Flush">
            <div>Straight Flush: 8x</div>

            <div className="probablity">
              <p
                className={` ${winbetSF == "A" ? "active" : "inactive"}`}
                onClick={() => handleclik("A", "SF")}
              >
                A
              </p>
              <p
                className={` ${winbetSF == "B" ? "active" : "inactive"}`}
                onClick={() => handleclik("B", "SF")}
              >
                B
              </p>
              <div className="bet-controls">
                <div>
                  <input
                    ...
                    type="number"
                    value={betAmountSF}
                    onChange={(e) => setbetAmountSF(Number(e.target.value))}
                    placeholder="Enter bet amount"
                    disabled={!isCrashed}
                  />
                  &nbsp;
                  <button
                    onClick={handlePlaceBetSF}
                    disabled={!isCrashed || isBetPlacedSF}
                  >
                    Place Bet
                  </button>
                  &nbsp;
